...
    // Same "page switching" sequence as start
    success = i2c_write_addr8_data8(0x80, 0x01);
    success &= i2c_write_addr8_data8(0xFF, 0x01);
    success &= i2c_write_addr8_data8(0x00, 0x00);
    success &= i2c_write_addr8_data8(0x91, stop_variable); // keep same stop_variable
    success &= i2c_write_addr8_data8(0x00, 0x01);
    success &= i2c_write_addr8_data8(0xFF, 0x00);
    success &= i2c_write_addr8_data8(0x80, 0x00);
...
    // Stop continuous back-to-back mode by writing 0x01 (single-shot) or 0x00 (stop) to SYSRANGE_START
    return i2c_write_addr8_data8(REG_SYSRANGE_START, 0x00); // stops continuous
}
